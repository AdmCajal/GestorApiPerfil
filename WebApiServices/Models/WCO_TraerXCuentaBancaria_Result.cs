...
namespace WebApiServices.Models
{
    ...
    public partial class WCO_TraerXCuentaBancaria_Result
    {
        ...
        public string CuentaLetraDesc { get; set; }
        public string CuentaLetraDescContrapartida { get; set; }
        public Nullable<decimal> MontoApertura { get; set; }
        public string NumCtaBanco { get; set; }
        public string SmartCredFlag { get; set; }
        ...
        public Nullable<int> SecuenciaCaja { get; set; }
        public string INKATEOficina { get; set; }
