    ...
    public class ADDAT_Sede
    {
        ...
        public List<WCO_ListarSede_Result> ListadoPaginado(WCO_ListarSede_Result ObjSede)
        {
            ...
            using (var context = new BDInmobiliariaEntities())
            {
                ...
                lst = context.WCO_ListarSede(ObjSede.SedDescripcion, iReturnValue, ObjSede.SedCodigo, ObjSede.IdEmpresa, ObjSede.SedEstado).ToList();
            }
            return lst;
        }
        ...
        public int Insertar(WCO_ListarSede_Result objBESede)
        {
            ...
            prm_Params[2] = new Parameter("@Telefono", objBESede.Telefono);
        ...
        #region Sucursal
        //public List<WCO_ListarSedeSucursal_Result> WCO_ListarSedeSucursal(WCO_ListarSedeSucursal_Result ObjSede)
        //{
        //    List<WCO_ListarSede_Result> lst = new List<WCO_ListarSede_Result>();
        //    using (var context = new BDInmobiliariaEntities())
        //    {
        ...
        //            iReturnValue = ObjSede.IdSede;
        //        }
        //        lst = context.WCO_ListarSedeSucursal(iReturnValue, ObjSede.Sucursal, ObjSede.IdSede, ObjSede., ObjSede.Estado).ToList();
        //    }
        //    return lst;
        //}
